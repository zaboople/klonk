...
# Download
[Download zip file here](http://zaboople.github.io/downloads/klonk.2.4.1.zip). Includes jar & Windows .exe files (for MacOS installation refer to "Building it" below). Note that the Windows .exe does not include the required Java 8 installation on your computer.
